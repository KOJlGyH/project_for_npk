...
# Form implementation generated from reading ui file 'choose_work.ui'
#
...
"")
        ...
        self.comboBox.setGeometry(QtCore.QRect(60, 140, 301, 51))
        self.comboBox.setObjectName("comboBox")
        self.satrt_check_button = QtWidgets.QPushButton(self.centralwidget)
        self.satrt_check_button.setGeometry(QtCore.QRect(60, 220, 271, 41))
        self.satrt_check_button.setStyleSheet("")
        self.satrt_check_button.setObjectName("satrt_check_button")
        self.back_button = QtWidgets.QPushButton(self.centralwidget)
        self.back_button.setGeometry(QtCore.QRect(20, 40, 161, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Выбор ученика"))
        self.satrt_check_button.setText(_translate("MainWindow", "Приступить к проверке"))
